...
//
//int linear_main_3pc_sh(int N, int D, int B, int IT, int testN, int pIdx, bool print, CLP& cmd, Session& chlPrev, Session& chlNext)
//{
//
//	PRNG prng(toBlock(1));
//	LinearModelGen gen;
...
//		else
//		{
//			SGD_Linear(params, p, train_data, train_label, W2);
//		}
//	}
//	//val_W2 = p.reveal(W2);
...
//
//
//int linear_main_3pc_sh(int argc, char** argv)
//{
//	CLP cmd(argc, argv);
