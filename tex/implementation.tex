...
\end{tabular}
\caption{	\label{fig:compare} \textcolor{red}{CAPTION, units, etc}}
\end{figure*}
...
\begin{figure*}[t!]\centering\footnotesize
	...
	\end{tabular}
	\caption{\label{fig:app}	\textcolor{red}{CAPTION, units, etc} }
\end{figure*}
